...
export const SEARCH_USER_KEYWORD = "search_user_keyword";
export const EMPTY_RESULT_KEYWORD = "empty_user_keyword";

const URL = {
  SEARCH_USER: "http://localhost:3000/api/search/users",
};

export const searchUserDataServer = setupServer(
  rest.get(URL.SEARCH_USER, (req, res, ctx) => {
