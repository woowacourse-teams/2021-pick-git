...
export const getPortfolioServerUpdateTime = () =>
  new Date(JSON.parse(localStorage.getItem(STORAGE_KEY.PORTFOLIO_SERVER_UPDATE_TIME) ?? "0"));
...
export const setPortfolioServerUpdateTime = (updateTime: Date) =>
  localStorage.setItem(STORAGE_KEY.PORTFOLIO_SERVER_UPDATE_TIME, JSON.stringify(updateTime));
