...
public class PortfolioControllerTest extends ControllerTest {
    ...
    class Authorized {
        ...
        class read {
            ...
            @Test
            void read_LoginUserWithYours_Success() throws Exception {
                // given
                LoginUser dani = new LoginUser("dani", ACCESS_TOKEN);
                String dada = "dada";
                ...
                // documentation
                perform.andDo(document("portfolio-readYours-loggedIn",
                    getDocumentRequest(),
                    getDocumentResponse(),
                    requestHeaders(
                        headerWithName(HttpHeaders.AUTHORIZATION)
        ...
        class Unauthorized {
            ...
            class read {
                ...
                @DisplayName("남의 포트폴리오 - 성공")
                @Test
                void read_GuestUserWithYours_Success() throws Exception {
                    // given
                    String dani = "dani";
                    ...
                    // documentation
                    perform.andDo(document("portfolio-readYours-unLoggedIn",
                        getDocumentRequest(),
                        getDocumentResponse(),
                        pathParameters(
                            parameterWithName("username").description("사용자 이름")
